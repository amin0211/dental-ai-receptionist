            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-2 h-[58px] w-full rounded-xl border border-slate-300 bg-white px-4 text-sm outline-none focus:border-blue-500 disabled:bg-slate-100 disabled:text-slate-400"
                >
                  <option value="">
                    {isLoadingDoctorServices
                      ? "Loading services..."
