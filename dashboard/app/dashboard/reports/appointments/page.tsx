          ...
          <div className="flex items-center justify-between gap-4 border-b border-slate-100 px-5 py-4">
            <div className="min-w-0">
              ...
              <p className="mt-1 truncate text-sm text-slate-500">
                Filter appointment records by date, patient, doctor, service,
                status, source, and urgency.
              </p>
            </div>
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <button
                ...
                className="h-9 rounded-lg border border-emerald-300 bg-emerald-50 px-3 text-sm font-semibold text-emerald-700 hover:bg-emerald-100 disabled:cursor-not-allowed disabled:opacity-50"
              >
                Export CSV
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 h-9 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm outline-none focus:border-blue-500"
                />
              </div>
              ...
              <div className="flex items-end">
                <div className="flex h-9 w-full items-center rounded-lg bg-slate-50 px-3 text-sm text-slate-600">
                ...
                <table className="w-full table-fixed text-left text-xs">
                  <thead className="bg-slate-50 text-[11px] uppercase tracking-wide text-slate-500">
                    <tr>
                      ...
                      <th className="w-[115px] px-3 py-3 font-semibold">
                        Time
                      </th>
                      ...
                      <th className="w-[90px] px-3 py-3 font-semibold">
                        Status
                      </th>
                    ...
                    {filteredAppointments.map((appointment) => (
                      <tr key={appointment.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-3 py-3 text-slate-700">
                          <div className="truncate">
                            {appointment.doctor_id
                              ? doctorNameById[appointment.doctor_id] ||
                                "Doctor"
                              : "-"}
                          </div>
                        </td>
                        ...
                        <td className="px-3 py-3">
                          <span
                            className={`inline-flex max-w-full rounded-full px-2 py-1 text-[11px] font-semibold capitalize ring-1 ring-inset ${getStatusBadgeClass(
                              appointment.status
                            )}`}
                          >
                            <span className="truncate">
                        ...
                        <td className="px-3 py-3">
                          <span
                            className={`inline-flex max-w-full rounded-full px-2 py-1 text-[11px] font-semibold capitalize ring-1 ring-inset ${getUrgencyBadgeClass(
                              appointment.urgency
                            )}`}
                          >
                            <span className="truncate">
